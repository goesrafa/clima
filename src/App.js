      ...
      <Navbar bg="info">
        ...
        <Form inline>
          <FormControl type="text" value={cidade} placeholder="Informe a cidade..."
            ...
            &nbsp;
          <Button variant="dark" onClick={() => { obtemClima(cidade) }}> <FaCloudversify color="#C0C0C0" /> Obter Clima</Button>
        </Form>
      </Navbar>
      <Jumbotron>
        <h1> <FaCloudversify /> FateClima</h1>
        <p>
          Consulte o clima de qualquer lugar do mundo. <br></br>
          App desenvolvido em ReactJS e integrado a API OpenWeatherMap.
        </p>
      </Jumbotron>
